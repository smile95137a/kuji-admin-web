...
const referralCodeRoutes: RouteRecordRaw[] = [
  {
    ...
    meta: { requiresAuth: true, roles: ['ROLE_ADMIN'], title: '推薦碼管理', layout: 'default' },
  },
  {
    path: 'referral-codes/add',
    name: 'AdminReferralCodeAdd',
    component: AdminReferralCodeEdit,
    meta: { requiresAuth: true, roles: ['ROLE_ADMIN'], title: '新增推薦碼', layout: 'default' },
  },
  {
    path: 'referral-codes/edit/:id',
    name: 'AdminReferralCodeEdit',
    component: AdminReferralCodeEdit,
    meta: { requiresAuth: true, roles: ['ROLE_ADMIN'], title: '編輯推薦碼', layout: 'default' },
  },
];
