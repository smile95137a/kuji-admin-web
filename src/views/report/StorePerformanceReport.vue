  ...
  <div class="store-performance-page">
    ...
    <MCard>
      ...
      <div class="sp-summary-row">
        ...
        <div class="sp-summary-card">
          <span class="sp-summary-card__label">明細資料</span>
          <strong class="sp-summary-card__value">
            {{ totalRowCount }} 筆
          </strong>
        </div>
      ...
      <MCard>
        ...
        <Form ref="formRef" :initial-values="initValues" @submit="onSubmit">
          <div class="sp-filter-grid">
            <div class="sp-filter-grid__store">
              <FormSelect
                v-if="isAdmin"
                label="店家"
                name="storeId"
            ...
            <div class="sp-filter-grid__date">
              <FormDateRangeField
                label="查詢日期"
                type="date"
    ...
    <div class="m-t-12">
      <MCard>
        ...
        <div v-else-if="loading" class="sp-state m-t-16">查詢中...</div>
          ...
          <div v-else class="m-t-16">
            ...
            <div v-if="chartOption" class="sp-chart m-t-20">
              <div class="sp-chart__head">
                <div>
                  <p class="sp-chart__title">店家績效趨勢圖</p>
                  <p class="sp-chart__sub">依目前資料呈現績效數據變化。</p>
                </div>
              </div>
            ...
            >
              <div class="sp-section-head">
                <p class="sp-section-head__title">{{ section.title }}</p>
...
const chartOption = computed(() => {
  ...
  const categoryField =
    'date' in firstRow
      ? 'date'
      : (['storeName', 'storeTitle', 'name', 'title'].find(
          (key) => key in firstRow,
...
async function onSubmit(values: any) {
  ...
  await executeApi({
    fn: async () => {
      ...
      return getStorePerformanceReport(req);
    },
    onSuccess: (res: any) => {
